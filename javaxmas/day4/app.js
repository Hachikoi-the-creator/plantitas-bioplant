...
// helpers
function getRandomIndex(max) { // min and max included 
    const min = 0
...
const messageContainer = document.getElementById('remaining-guesses')
const emojiCluesContainer = document.getElementById('clues-container')
...
function testRemoving() {
    ...
    console.log(getRandomIndex(films.length))
}
